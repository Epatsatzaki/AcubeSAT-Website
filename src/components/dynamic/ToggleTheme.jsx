// src/components/dynamic/ToggleTheme.jsx
...
const ToggleTheme = () => {
  ...
  useEffect(() => {
    // Check if theme is explicitly set to light, otherwise default to dark
    const isLightMode = localStorage.getItem('theme') === 'light'
    const shouldBeDark = !isLightMode // Default to dark unless explicitly light
